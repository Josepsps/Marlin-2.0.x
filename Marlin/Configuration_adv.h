...
//#define CODEPENDENT_XY_HOMING
  ...
  // mod jp bltouch  *cambiar si hace falta
 ...
 */
// mod jp sin tocar *cambiar       (Only if where aliasing between axes in multi-axis moves causes audible vibration and surface artifacts.
